...
import com.TaskManagement1.DTO.UserProfileDTO;
import com.TaskManagement1.Service.UserProfileService;
...
//	}
	...
	@GetMapping("/{email}")
	public ResponseEntity<UserProfileDTO> getProfileByEmail(@PathVariable("email") String userOrganizationEmail) {
	    return ResponseEntity.ok(userProfile.getProfileByOrganizationEmail(userOrganizationEmail));
	}
...
//	}
	...
	@PutMapping("/update/{email}")
	public ResponseEntity<UserProfileDTO> update(@PathVariable("email") String userOrganaziationEmail,
